# Tichex Genesis State

Tichex genesis state, `GenesisState`, is composed of accounts, various module
...
The Tichex genesis state is defined as follows:
...
In the ABCI `initChainer` definition of Tichex the `initFromGenesisState` is called
